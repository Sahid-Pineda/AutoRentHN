"""
Django settings for AutoRentHN project.
...
SECRET_KEY = 'django-insecure-3zf+$_3tq)5j*f%ylwo$kgpg+2f2+qj6gs+p5(zt7ao-zwe08q'
...
WSGI_APPLICATION = 'AutoRentHN.wsgi.application'
